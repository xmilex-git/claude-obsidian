...
## Last Updated
2026-04-29 (latest). **CBRD-26722 knowledge dump ingest — parallel index scan on partitioned tables.** Branch-WIP capture from `parallel_scan_all` HEAD `7fdb82099` (4 commits beyond the prior PR #7062 review snapshot `0f8a107bb`). Two new pages:
